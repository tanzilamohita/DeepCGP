...
accuracy_df = accuracy_df.transpose()
accuracy_df.index = np.arange(1, len(accuracy_df)+1)
print(accuracy_df)
...
plt.title("BayesB Prediction Accuracy for HDRA", fontsize=24) #(Traits 1-9)
...
plt.legend(fontsize=12, loc='upper right')
           # bbox_to_anchor=(0.5, 0.25), fancybox=True, shadow=True, ncol=3)
...
plt.savefig('../HDRA_Data/HDRA_Prediction_Accuracy/'
                       'HDRA_PredictionAccuracy_BayesB_Trait_Id.png')
plt.show()
