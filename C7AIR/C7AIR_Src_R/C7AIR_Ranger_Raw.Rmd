---
title: "Random Forest Regression (Ranger) for C7AIR Raw Data"
...
# prepare independent variables (6414 SNPs!)
...
```{r}
saveRDS(y.out, 
        here("C7AIR/C7AIR_Data/C7AIR_Prediction_Result", "C7AIR_PredictedOutput_Raw.rds"))
```
output data as csv
```{r}
write.csv(y.out, here("C7AIR/C7AIR_Data/C7AIR_Prediction_Result",  "C7AIR_PredictedOutput_Raw.csv"), quote = F)
```
output prediction accuracy 
```{r}
write.csv(y.predresult, here("C7AIR/C7AIR_Data/C7AIR_Prediction_Result",  "C7AIR_PredictionAccuracy_Raw.csv"), quote = F)
```