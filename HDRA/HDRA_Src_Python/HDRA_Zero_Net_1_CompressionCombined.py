...
Net_1_Compressed_fileList = natsorted(glob.glob("../HDRA_Data/HDRA_ModelMetaData/HDRA_Zero/"
                            "HDRA_Zero_Net_1/HDRA_Zero_Net_1_EncData/"+"*.csv"))
...
Net_1_Compressed_csv.to_csv("../HDRA_Data/HDRA_Zero_CompressedData/HDRA_Compress_1.csv",
