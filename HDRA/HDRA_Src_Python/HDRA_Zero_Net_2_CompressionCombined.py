...
Net_2_Compressed_fileList = natsorted(glob.glob("../HDRA_Data/HDRA_ModelMetaData/HDRA_Zero/HDRA_Zero_Net_2/HDRA_Zero_Net_2_EncData/"+"*.csv"))
...
Net_2_Compressed_csv.to_csv("../HDRA_Data/HDRA_Zero_CompressedData/HDRA_Compress_2.csv",
