...
accuracy_df = accuracy_df/accuracy_df[0]*100 # for calculating Relative Accuracy
...
accuracy_df.plot.line(figsize=(12, 8))
...
plt.savefig('../C7AIR_Data/C7AIR_Prediction_Accuracy/'
                       'C7AIR_PredictionRelativeAccuracy_LinePlot.png')
plt.show()
