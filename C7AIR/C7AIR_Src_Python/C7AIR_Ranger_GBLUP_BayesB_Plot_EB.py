...
# set height of bar
C7AIR_raw_mean_ranger = statistics.mean(list(C7AIR_raw_ranger.mean(axis=0)*100))
C7AIR_comp1_mean_ranger = statistics.mean(list(C7AIR_comp1_ranger.mean(axis=0)*100))
C7AIR_comp2_mean_ranger = statistics.mean(list(C7AIR_comp2_ranger.mean(axis=0)*100))
...
# set height of bar
C7AIR_raw_mean_gblup = statistics.mean(list(C7AIR_raw_gblup.mean(axis=0)*100))
C7AIR_comp1_mean_gblup= statistics.mean(list(C7AIR_comp1_gblup.mean(axis=0)*100))
C7AIR_comp2_mean_gblup = statistics.mean(list(C7AIR_comp2_gblup.mean(axis=0)*100))
...
# set height of bar
C7AIR_raw_mean_BayesB = statistics.mean(list(C7AIR_raw_BayesB.mean(axis=0)*100))
C7AIR_comp1_mean_BayesB = statistics.mean(list(C7AIR_comp1_BayesB.mean(axis=0)*100))
C7AIR_comp2_mean_BayesB = statistics.mean(list(C7AIR_comp2_BayesB.mean(axis=0)*100))
