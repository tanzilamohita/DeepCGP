...
# accuracy_data = [hdra_comp1_list, hdra_comp2_list, hdra_comp3_list]
...
accuracy_df.columns = list(hdra_comp2)[1:19]
...
# plt.savefig('../HDRA_Data/HDRA_Prediction_Accuracy/'
#                        'HDRA_PredictionAccuracy_GBLUP.png')
plt.show()
